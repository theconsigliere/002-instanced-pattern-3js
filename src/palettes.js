...
export const sinPalettes = {
  black: {
    ...
    c2: new Color(0.4, 0.4, 0.4),
    c3: new Color(0.0, 0.00, 0.00),
    offset: 0.3
  },
  pink: {
    c0: new Color(1.6500000000000001, 0.55, 0.4),
    c1: new Color(0.2, 0.25, 0.15000000000000002),
    c2: new Color(0.40000000000000004, 0.7, 0.45),
    c3: new Color(0.75, 0.8, 0.8),
    offset: 0.3
  },
  aquamarine: {
    c0: new Color(0.4, 0.25, 0.2),
    c1: new Color(0.45, 0.45, 0.15000000000000002),
    c2: new Color(0.4, 0.4, 1.9000000000000001),
    c3: new Color(0.30000000000000004, 0.3, 0.300000000000001),
    offset: 0.3
  },
  blue: {
  ...
  blue: {
    c0: new Color(0.6500000000000001, 0.5500000000000001, 0.4),
    c1: new Color(0.2, 0.4, 0.35000000000000003),
    c2: new Color(0.4, 0.4, 0.1),
    c3: new Color(0.4, 0.4, 0.5500000000000001),
    offset: 0.3
  },
  darkblue: {
    c0: new Color(0.65, 0.7000000000000001, 0.7000000000000001),
    c1: new Color(0.65, 0.0000000000000001, 0.2000000000000001),
    c2: new Color(0.4, 0.4, 0.4),
    c3: new Color(0.9500000000000001, 0.25, 0.55),
    offset: 0.3
  },
  grey: {
    c0: new Color(0.2, 0.2, 0.4),
    c1: new Color(0.8, 0.8, 0.2000000000000002),
    c2: new Color(0.4, 0.4, 0),
    c3: new Color(0, 0, 0.2),
    offset: 1.2
  },
  white: {
    c0: new Color(0.35000000000000003, 0, 0.2),
    // c0: new Color(0.7, 0, 0.2),
    c1: new Color(.5, .2, .5),
    c2: new Color(0.22, 0.33, 0.22),
    c3: new Color(0.6, 0.1, 0),
    offset: 0.9
  },
  orange: {
    c0: new Color(0.45, 0, 0.2),
    c1: new Color(1, 0.05, 0),
